...
const NotFound = () => {
  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col justify-center text-center md:-mt-32 dark:text-gray-100 text-gray-900">
        <h1 className="md:text-4xl text-sm">
          Oops...<span className="text-rose-500">404</span> Page not found
        </h1>
        <p className="py-2">
          You will be redirected to
          <Link href="/">
            <a>
              <span className="text-rose-500 hover:text-rose-700 transition duration-300">
                &nbsp;Home Page&nbsp;
              </span>
            </a>
          </Link>
